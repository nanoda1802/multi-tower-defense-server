...
export const spawnMonsterHandler = (socket) => { //userId로 찾기??
        ...
        enemyPlayer.setMonster(monsterId, monsterData);
        // [3]  monsterId, monsterNumber 패킷으로 감싸기 
        let myPacket = makePacketBuffer(config.packetType.spawnMonsterRequest, sequence, {monsterId, monsterNumber});
        let enemyPacket = makePacketBuffer(config.packetType.spawnEnemyMonsterNotification, sequence, {monsterId, monsterNumber});
        // [4] packet 보내주기
