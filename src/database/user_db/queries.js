const USER_SQL_QUERIES = {
  ...
  SELECT_USER_WITH_RANK: `SELECT u.id, u.password, r.win_count, r.lose_count, r.mmr, r.high_score FROM users AS u INNER JOIN ranks AS r ON u.id = r.user_id WHERE u.id = ?`,
};
